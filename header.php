...
<head>
    ...
    <link rel="icon" href="./iconandlogo/icon.png">
...
<body class="Vegur row">
    <header class="bg-pink">
        <div class="content-wrapper bg-pink" style="width: 85%;height: fit-content;padding: 5px 0 3 0 !important;">
            <div class="link-icons">
                <a href="index?page=cart" style="font-size: 18px !important;">
                    Cart
                    <i class="fas fa-shopping-cart txt-color-black"></i>
                    <span style="top: 0px ;position: absolute; background-color:brown"><?= $num_items_in_cart ?></span>
                </a>
            </div>
        </div>
    </header>
        ...
        <nav class="row navbar navbar-expand-lg navbar-dark lighten-1 d-flex justify-content-center secondary-color p-0" style="width: 100%">
            <div class=" navbar-nav clearfix" id="header" style="width: 85%">
                <div class="head-col-left col-lg-3 col-12 text-center">
                    <a href="./index"><img src="./iconandlogo/logo.png" class="m-2" alt="Logo" style="height: 100px !important; "></a>
                </div>
