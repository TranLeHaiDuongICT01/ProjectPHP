...
?>
<div class="wrapper-user d-flex justify-content-center mx-auto" style="background-color:whitesmoke ; width:90%; min-height: 300px; flex-wrap:wrap">
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 col-12 py-3 px-1">
        <table class="table table-danger table-hover" style=" text-align: start; "> 
            <tr>
                <td colspan="2">
                    <h3 class="truncated">My Profile</h3>
                </td>
            </tr> 
            <tr>
                <td>First Name</td>
    ...
    <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 col-12 py-3 px-1">
        <table class="table table-info table-hover">
            ...
            <?php foreach ($products as $product) :  ?>
                ...
                <tr>
                    <td><a class="truncated wrap" href="index?page=product&id=<?= $product['productID'] ?>">
