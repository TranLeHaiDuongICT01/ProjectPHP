...
<div class="product content-wrapper d-flex" style="width: 80%; flex-wrap:wrap ">
    ...
    <div class="col-lg-6  col-12 px-4">
        <h3 class="name py-4"><?= $main_product['name'] ?></h3>
        ...
        <form action="index?page=cart" method="post"> <h4>quantity:</h4>
            ...
            <p><a class="truncated wrap" href="download.php?file=<?= $main_product['file'] ?>">Download detailed informations of the product</a></p> 
            <?= $main_product['desci'] ?> 
    </div>
</div>
