                ...
                <div class="float-right d-flex justify-content-end ">
                    ...
                    <div class="aria-widget-slider">
                        ...
                        <div class="rail justify-content-center" id="rail" style="width:160px; ">
                            <img id="minPricex" src="imgs/min-arrow.png" role="slider" tabindex="0" class="min thumb" aria-valuemin="0" aria-valuenow="<?= $min ?>" aria-valuetext="<?= $min ?>" aria-valuemax="500" aria-label="Hotel Minimum Price">
                            <img id="maxPricex" src="imgs/max-arrow.png" role="slider" tabindex="0" class="max thumb" aria-valuemin="0" aria-valuenow="<?= $max ?>" aria-valuetext="<?= $max ?>" aria-valuemax="500" aria-label="Hotel Maximum Price">
