...
$stmt = $pdo->prepare('SELECT * FROM products  WHERE stt = 1 ORDER BY date_added DESC LIMIT 20');
$stmt->execute();
...
<div class="products content-wrapper text-center" style="width: 85%">
    ...
    <div class="col-lg-10 col-xs-12 d-flex mx-auto justify-content-start " style="flex-wrap: wrap;">
